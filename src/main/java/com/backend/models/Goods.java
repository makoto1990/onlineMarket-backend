...
public class Goods {
    ...
    public boolean equals(Object o) {
        ...
        if (storeWay != null ? !storeWay.equals(goods.storeWay) : goods.storeWay != null) return false;
        if (sourceArea != null ? !sourceArea.equals(goods.sourceArea) : goods.sourceArea != null) return false;
        if (setDate != null ? !setDate.equals(goods.setDate) : goods.setDate != null) return false;
        ...
        if (leastAmount != null ? !leastAmount.equals(goods.leastAmount) : goods.leastAmount != null) return false;
        if (largeAmount != null ? !largeAmount.equals(goods.largeAmount) : goods.largeAmount != null) return false;
        if (largePrice != null ? !largePrice.equals(goods.largePrice) : goods.largePrice != null) return false;
